# GuestKit legal (Zyvor)

| Document | Purpose |
|----------|---------|
| [LICENSE](../../LICENSE) | **LGPL-3.0-or-later** — GuestKit source code |
| [ZYVOR-COMPANY-TERMS.md](../../ZYVOR-COMPANY-TERMS.md) | Zyvor brand / binary distribution (accept on deploy & install) |
