...
| **Day-0 plan/rescue** | Expanded Unreleased; offline GRUB repair via `fix-grub` shipped |
...
| Item | Notes |
|------|-------|
| *(none currently parked)* | AES SAM hash write + PackageInstall host fetch shipped Unreleased |
